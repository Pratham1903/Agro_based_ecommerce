<%@ Page Title="fruit seeds" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="fruit_seeds_det.aspx.cs" Inherits="Final_Project.WebForm7" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="bread_nav">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="seeds.aspx">Seeds</a></li>
            <li class="breadcrumb-item"><a href="seeds.aspx?cat=fru">Fruit Seeds</a></li>
