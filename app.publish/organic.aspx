<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="organic.aspx.cs" Inherits="Final_Project.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="head">
                <div class="description">
                    <asp:Label ID="descp" runat="server" Text="BIO/ORGANIC" />
                </div>
            </div>
            <div class="all_seeds">
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="5" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" DataSourceID="SqlDataSource2" OnItemCommand="DataList1_ItemCommand">
                    ...
                    <div class="seeds_types">
                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Eval("org_name") %>' />
                        <asp:HiddenField ID="HiddenField2" runat="server" Value='<%# Eval("category") %>' />
                        <asp:HiddenField ID="HiddenField3" runat="server" Value='<%# Eval("org_brand") %>' />
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl='<%# Eval("org_img") %>' width="220px" Height="180px" CssClass="image_style" CommandName="view" CommandArgument='<%# Eval("org_id") + "," + Eval("org_name") + "," + Eval("org_brand") + "," + Eval("category") %>'/>
                        <br />
                        <div class="details">
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("org_name") %>' Font-Size="15px"></asp:Label>
                        <br />
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("org_brand") %>' Font-Size="12px" ForeColor="#908D9D"></asp:Label>
                            <br />
                            <br />
                            ...
                            <br />
                             <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="no-expand" OnClick="openModal()">
                                <asp:ListItem Value="10 gms">10 gms</asp:ListItem>
                            </asp:DropDownList>
                            &nbsp;&nbsp;
                            <br />
                            <br />
                            <asp:Button ID="Button1" runat="server" BackColor="Red" Text="Buy Now" CommandName="view" CommandArgument='<%# Eval("org_id") + "," + Eval("org_name") + "," + Eval("org_brand") + "," + Eval("category") %>'  />
                            <asp:Button ID="view" runat="server" Text="view details" CommandName="view" CommandArgument='<%# Eval("org_id") + "," + Eval("org_name") + "," + Eval("org_brand") + "," + Eval("category") %>' />
                    </div>
                </ItemTemplate>
            </asp:DataList>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:major_projectConnectionString7 %>' DeleteCommand="DELETE FROM [organic] WHERE [org_id] = @org_id" InsertCommand="INSERT INTO [organic] ([org_id], [org_img], [org_brand], [org_name], [dis_price], [org_price], [size], [category]) VALUES (@org_id, @org_img, @org_brand, @org_name, @dis_price, @org_price, @size, @category)" SelectCommand="SELECT * FROM [organic]" UpdateCommand="UPDATE [organic] SET [org_img] = @org_img, [org_brand] = @org_brand, [org_name] = @org_name, [dis_price] = @dis_price, [org_price] = @org_price, [size] = @size, [category] = @category WHERE [org_id] = @org_id">
                    <DeleteParameters>
                        <asp:Parameter Name="org_id" Type="Int32"></asp:Parameter>
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="org_id" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="org_img" Type="String"></asp:Parameter>
                        <asp:Parameter Name="org_brand" Type="String"></asp:Parameter>
                        <asp:Parameter Name="org_name" Type="String"></asp:Parameter>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='<%$ ConnectionStrings:major_projectConnectionString7 %>' SelectCommand="SELECT * FROM [organic] WHERE ([category] = @category)">
                <SelectParameters>
    ...
    <div class="all_seeds">
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString='<%$ ConnectionStrings:major_projectConnectionString9 %>' SelectCommand="SELECT * FROM [organic] WHERE ([all_category] = @all_category)">
                    <SelectParameters>
...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <div class="size_details">
            <asp:Label ID="gms" CssClass="gms" runat="server" Text="3500 seeds"></asp:Label><br /><br />
            <span style="color: rgb(77, 81, 86);font-weight:bold; font-family: Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">₹</span><asp:Label ID="Label3" runat="server" Text="999" Font-Size="16px"></asp:Label>
                            &nbsp; <span style="color: rgb(77, 81, 86);font-weight:bold; font-family: Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">₹</span><asp:Label ID="Label4" runat="server" Text="1450" Font-Strikeout="True" ForeColor="#908D9D"></asp:Label>
            <div class="offer">
                31% off
            </div>
            <div class="saved">
             ...
             <div class="cartbtn">
                    <asp:Button ID="addcart" CssClass="addcart" runat="server" Text="Add To Cart" />
             </div>
        </div>
        <hr />
        <div class="size_details">
            <asp:Label ID="Label6" CssClass="gms" runat="server" Text="7000 seeds(pack of 3500 seeds * 2)"></asp:Label><br /><br />
            <span style="color: rgb(77, 81, 86);font-weight:bold; font-family: Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">₹</span><asp:Label ID="Label7" runat="server" Text="999" Font-Size="16px"></asp:Label>
                            &nbsp; <span style="color: rgb(77, 81, 86);font-weight:bold; font-family: Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">₹</span><asp:Label ID="Label8" runat="server" Text="1450" Font-Strikeout="True" ForeColor="#908D9D"></asp:Label>
            <div class="offer">
                31% off
            </div>
            <div class="saved">
        ...
        <hr />
        <div class="size_details">
            <asp:Label ID="Label9" CssClass="gms" runat="server" Text="17500 seeds(pack of 3500 seeds * 5)"></asp:Label><br /><br />
            <span style="color: rgb(77, 81, 86);font-weight:bold; font-family: Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">₹</span><asp:Label ID="Label10" runat="server" Text="999" Font-Size="16px"></asp:Label>
                            &nbsp; <span style="color: rgb(77, 81, 86);font-weight:bold; font-family: Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">₹</span><asp:Label ID="Label11" runat="server" Text="1450" Font-Strikeout="True" ForeColor="#908D9D"></asp:Label>
            <div class="offer">
                31% off
            </div>
            <div class="saved">
