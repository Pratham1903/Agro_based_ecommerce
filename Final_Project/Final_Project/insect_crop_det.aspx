<%@ Page Title="Insecticides Crop" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="insect_crop_det.aspx.cs" Inherits="Final_Project.WebForm12" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="bread_nav">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="crop_protection.aspx?cat=insect">Insecticides Crop</a></li>
