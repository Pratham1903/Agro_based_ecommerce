...
namespace Final_Project
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        //SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-PA4N9Q9\SQL2014;Initial Catalog=major_project;Integrated Security=True");
        ...
        protected void DataList1_ItemCommand(object sender, DataListCommandEventArgs e)
        {
            if (e.CommandName == "addtocart")
            {
                ...
                if (sizeVariantLabel != null && !string.IsNullOrEmpty(sizeVariantLabel.Text))
                {
                    ...
                    Response.Redirect("addtocart.aspx?seed_name=" + e.CommandArgument.ToString() + "&size=" + selectedSize + "&Quantity=" + txtbox.Text);
                }
                else
                {
            ...
            if (clickedButton != null)
            {
                ...
                if (item != null)
                {
                    ...
                    if (lblDisPrice != null && lblOrgPrice != null)
                    {
                        ...
                        if (clickedButton.CommandArgument == "10 gms")
                        {
                            // No multiplier needed for 10 gms
                        }
                        else if (clickedButton.CommandArgument == "100 gms(pack of 10 gms * 10)")
                        {
                            disPrice *= 10; // Multiply by 10 for 100 gms size
                            orgPrice *= 10; // Multiply by 10 for 100 gms size
                        }
                        else if (clickedButton.CommandArgument == "500 gms(pack of 100 gms * 5)")
                        {
