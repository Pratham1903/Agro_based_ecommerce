<%@ Page Title="Bio Insecticides" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="bio_insecticides_org_det.aspx.cs" Inherits="Final_Project.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="bread_nav">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="organic.aspx?cat=all">org Protection</a></li>
            <li class="breadcrumb-item"><a href="organic.aspx?cat=bio_insect">Insecticides org</a></li>
    ...
    <ContentTemplate>
    <asp:DataList ID="DataList1" runat="server" DataKeyField="org_id" OnItemDataBound="DataList1_ItemDataBound" DataSourceID="SqlDataSource1" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
                <div class="image">
                    <asp:Image ID="Image1" CssClass="img" runat="server" ImageUrl='<%# Eval("org_img") %>' width="500" Height="650"/>
                </div>
                <div class="seedname">
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("org_name") %>'  Font-Size="30px"></asp:Label>
                </div>
                <div class="seebrand">
                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("org_brand") %>'  Font-Size="16px"></asp:Label><br />
                    <br>
                    <br></br>
                ...
                <div class="order_btn">
                   ...
                   <asp:Button ID="cart_now" CssClass="addcart" runat="server" Text="Add To Cart"  CommandArgument='<%# Eval("org_name")%>' CommandName="addtocart" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:major_projectConnectionString9 %>' SelectCommand="SELECT * FROM [organic] WHERE (([org_id] = @org_id) AND ([org_name] = @org_name)  AND ([org_brand] = @org_brand))">
        <SelectParameters>
            <asp:QueryStringParameter QueryStringField="orgid" DefaultValue="" Name="org_id" Type="Int32"></asp:QueryStringParameter>
            <asp:QueryStringParameter QueryStringField="name" Name="org_name" Type="String"></asp:QueryStringParameter>
            <%--<asp:QueryStringParameter QueryStringField="cat" Name="category" Type="String"></asp:QueryStringParameter>--%>
            <asp:QueryStringParameter QueryStringField="brand" Name="org_brand" Type="String"></asp:QueryStringParameter>
        </SelectParameters>
    </asp:SqlDataSource>
